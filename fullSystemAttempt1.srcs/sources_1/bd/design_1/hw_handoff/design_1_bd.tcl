...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set OUT_LED [ create_bd_port -dir O OUT_LED ]

  # Create instance: Fake_Buffer_0, and set properties
  set block_name Fake_Buffer
  set block_cell_name Fake_Buffer_0
  if { [catch {set Fake_Buffer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Fake_Buffer_0 eq "" } {
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: baseLocalPlanner_1_0, and set properties
  set baseLocalPlanner_1_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:baseLocalPlanner_1:1.0 baseLocalPlanner_1_0 ]
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#USB Reset#Quad SPI Flash#GPIO#GPIO#ENET Reset#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#reset#qspi_fbclk#gpio[9]#gpio[10]#reset#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#gpio[40]#gpio[41]#gpio[42]#gpio[43]#gpio[44]#gpio[45]#gpio[46]#gpio[47]#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
...
CONFIG.C_BRAM_CNT.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins baseLocalPlanner_1_0/S00_AXIS_PATH_DIST_MAP]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins baseLocalPlanner_1_0/S01_AXIS_COSTMAP]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M01_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph_1/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins baseLocalPlanner_1_0/S00_AXI_CONFIG] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Fake_Buffer_0_out_rdy [get_bd_ports OUT_LED] [get_bd_pins Fake_Buffer_0/out_rdy]
  ...
  connect_bd_net -net baseLocalPlanner_1_0_db_cell_x [get_bd_pins Fake_Buffer_0/db_cell_x] [get_bd_pins baseLocalPlanner_1_0/db_cell_x] [get_bd_pins system_ila/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_cell_x]
  connect_bd_net -net baseLocalPlanner_1_0_db_cell_y [get_bd_pins Fake_Buffer_0/db_cell_y] [get_bd_pins baseLocalPlanner_1_0/db_cell_y] [get_bd_pins system_ila/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_cell_y]
  connect_bd_net -net baseLocalPlanner_1_0_db_config_tg_start [get_bd_pins Fake_Buffer_0/db_config_tg_start] [get_bd_pins baseLocalPlanner_1_0/db_config_tg_start] [get_bd_pins system_ila/probe9]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_config_tg_start]
  connect_bd_net -net baseLocalPlanner_1_0_db_cost_total [get_bd_pins Fake_Buffer_0/db_cost_total] [get_bd_pins baseLocalPlanner_1_0/db_cost_total] [get_bd_pins system_ila/probe6]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_cost_total]
  connect_bd_net -net baseLocalPlanner_1_0_db_fpc_cost [get_bd_pins Fake_Buffer_0/db_fpc_cost] [get_bd_pins baseLocalPlanner_1_0/db_fpc_cost] [get_bd_pins system_ila/probe3]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_fpc_cost]
  connect_bd_net -net baseLocalPlanner_1_0_db_fpc_cost_rdy [get_bd_pins Fake_Buffer_0/db_fpc_cost_rdy] [get_bd_pins baseLocalPlanner_1_0/db_fpc_cost_rdy] [get_bd_pins system_ila/probe12]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_fpc_cost_rdy]
  connect_bd_net -net baseLocalPlanner_1_0_db_fpc_start [get_bd_pins Fake_Buffer_0/db_fpc_start] [get_bd_pins baseLocalPlanner_1_0/db_fpc_start] [get_bd_pins system_ila/probe2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_fpc_start]
  connect_bd_net -net baseLocalPlanner_1_0_db_occ_out_test [get_bd_pins Fake_Buffer_0/db_occ_out_test] [get_bd_pins baseLocalPlanner_1_0/db_occ_out_test] [get_bd_pins system_ila/probe8]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_occ_out_test]
  connect_bd_net -net baseLocalPlanner_1_0_db_path_dist_map_add [get_bd_pins Fake_Buffer_0/db_path_dist_map_add] [get_bd_pins baseLocalPlanner_1_0/db_path_dist_map_add] [get_bd_pins system_ila/probe4]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_path_dist_map_add]
  connect_bd_net -net baseLocalPlanner_1_0_db_path_goal_cost [get_bd_pins Fake_Buffer_0/db_path_goal_cost] [get_bd_pins baseLocalPlanner_1_0/db_path_goal_cost] [get_bd_pins system_ila/probe5]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_path_goal_cost]
  connect_bd_net -net baseLocalPlanner_1_0_db_theta_out_test [get_bd_pins Fake_Buffer_0/db_theta_out_test] [get_bd_pins baseLocalPlanner_1_0/db_theta_out_test] [get_bd_pins system_ila/probe7]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_db_theta_out_test]
  connect_bd_net -net baseLocalPlanner_1_0_goal_dist_port [get_bd_pins Fake_Buffer_0/goal_dist_port] [get_bd_pins baseLocalPlanner_1_0/goal_dist_port] [get_bd_pins system_ila/probe11]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_goal_dist_port]
  connect_bd_net -net baseLocalPlanner_1_0_path_dist_port [get_bd_pins Fake_Buffer_0/path_dist_port] [get_bd_pins baseLocalPlanner_1_0/path_dist_port] [get_bd_pins system_ila/probe10]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets baseLocalPlanner_1_0_path_dist_port]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins baseLocalPlanner_1_0/s00_axi_config_aclk] [get_bd_pins baseLocalPlanner_1_0/s00_axis_path_dist_map_aclk] [get_bd_pins baseLocalPlanner_1_0/s01_axis_costmap_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph_1/ACLK] [get_bd_pins ps7_0_axi_periph_1/M00_ACLK] [get_bd_pins ps7_0_axi_periph_1/M01_ACLK] [get_bd_pins ps7_0_axi_periph_1/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins system_ila/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph_1/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins baseLocalPlanner_1_0/s00_axi_config_aresetn] [get_bd_pins baseLocalPlanner_1_0/s00_axis_path_dist_map_aresetn] [get_bd_pins baseLocalPlanner_1_0/s01_axis_costmap_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_1/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x83C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs baseLocalPlanner_1_0/S00_AXI_CONFIG/S00_AXI_CONFIG_reg] SEG_baseLocalPlanner_1_0_S00_AXI_CONFIG_reg

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.6.5b  2016-09-06 bk=1.3687 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port OUT_LED -pg 1 -y 160 -defaultsOSRD
preplace port DDR -pg 1 -y 340 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 360 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 750 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 3 -y 550 -defaultsOSRD
preplace inst axi_mem_intercon_1 -pg 1 -lvl 4 -y 410 -defaultsOSRD
preplace inst axi_dma_1 -pg 1 -lvl 3 -y 380 -defaultsOSRD
preplace inst system_ila -pg 1 -lvl 8 -y 540 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -y 600 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 6 -y 210 -defaultsOSRD
preplace inst Fake_Buffer_0 -pg 1 -lvl 8 -y 180 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 170 -defaultsOSRD
preplace inst baseLocalPlanner_1_0 -pg 1 -lvl 7 -y 130 -defaultsOSRD
preplace inst ps7_0_axi_periph_1 -pg 1 -lvl 2 -y 510 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y 430 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 5 4 NJ 340 NJ 340 2600J 350 2980J
preplace netloc baseLocalPlanner_1_0_db_path_goal_cost 1 7 1 2610
preplace netloc baseLocalPlanner_1_0_db_cell_x 1 7 1 2660
preplace netloc baseLocalPlanner_1_0_path_dist_port 1 7 1 2540
preplace netloc baseLocalPlanner_1_0_db_occ_out_test 1 7 1 2560
preplace netloc baseLocalPlanner_1_0_db_cell_y 1 7 1 2650
preplace netloc axi_dma_1_M_AXIS_MM2S 1 3 4 1000 50 NJ 50 NJ 50 2090J
...
preplace netloc baseLocalPlanner_1_0_db_fpc_cost_rdy 1 7 1 2570
preplace netloc processing_system7_0_M_AXI_GP1 1 5 1 1780
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 10 NJ 10 NJ 10 NJ 10 NJ 10 1760
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1330
preplace netloc baseLocalPlanner_1_0_goal_dist_port 1 7 1 2530
preplace netloc baseLocalPlanner_1_0_db_fpc_cost 1 7 1 2630
preplace netloc baseLocalPlanner_1_0_db_fpc_start 1 7 1 2640
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 5 350 770 NJ 770 1020 770 NJ 770 1790
preplace netloc axi_dma_0_M_AXI_MM2S 1 3 1 1010
preplace netloc xlconcat_0_dout 1 4 1 1330
preplace netloc processing_system7_0_FIXED_IO 1 5 4 NJ 360 NJ 360 NJ 360 NJ
preplace netloc ps7_0_axi_periph_1_M01_AXI 1 2 1 640
preplace netloc baseLocalPlanner_1_0_db_cost_total 1 7 1 2590
preplace netloc axi_dma_0_mm2s_introut 1 3 1 990
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 6 370 790 670 790 1040 790 NJ 790 1800 790 2110
preplace netloc ps7_0_axi_periph_1_M00_AXI 1 2 1 650
preplace netloc baseLocalPlanner_1_0_db_config_tg_start 1 7 1 2550
preplace netloc baseLocalPlanner_1_0_db_theta_out_test 1 7 1 2580
preplace netloc Fake_Buffer_0_out_rdy 1 8 1 2980
preplace netloc baseLocalPlanner_1_0_db_path_dist_map_add 1 7 1 2620
preplace netloc processing_system7_0_FCLK_CLK0 1 0 8 30 130 360 130 660 130 1030 530 1320 580 1770 90 2080 410 N
preplace netloc axi_dma_0_M_AXIS_MM2S 1 3 4 NJ 540 1310J 70 NJ 70 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 6 1 2100
preplace netloc axi_dma_1_mm2s_introut 1 3 1 1000
levelinfo -pg 1 0 190 510 830 1180 1540 1950 2320 2830 3000 -top -40 -bot 1300
",
}
