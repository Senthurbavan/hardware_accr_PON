...
proc create_root_design { parentCell } {
  ...
  set probe4 [ create_bd_port -dir I -from 13 -to 0 probe4 ]
  set probe5 [ create_bd_port -dir I -from 31 -to 0 probe5 ]
  set probe6 [ create_bd_port -dir I -from 31 -to 0 probe6 ]
  set probe7 [ create_bd_port -dir I -from 13 -to 0 probe7 ]
  set probe8 [ create_bd_port -dir I -from 10 -to 0 probe8 ]
