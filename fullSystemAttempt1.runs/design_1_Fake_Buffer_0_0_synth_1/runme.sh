...
HD_PWD='C:/Users/User/Documents/Vivado_2016_4/fullSystemAttempt1/fullSystemAttempt1.runs/design_1_Fake_Buffer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Fake_Buffer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Fake_Buffer_0_0.tcl
