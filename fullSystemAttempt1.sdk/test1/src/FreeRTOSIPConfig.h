...
used as defaults. */
#define ipconfigSOCK_DEFAULT_RECEIVE_BLOCK_TIME	( 15 )////5000
#define	ipconfigSOCK_DEFAULT_SEND_BLOCK_TIME	( 1 )////5000

/* Include support for LLMNR: Link-local Multicast Name Resolution
(non-Microsoft) */
#define ipconfigUSE_LLMNR					( 0 )//e

/* Include support for NBNS: NetBIOS Name Service (Microsoft) */
#define ipconfigUSE_NBNS					( 0 )//e
...
#define ipconfigIP_TASK_STACK_SIZE_WORDS	( configMINIMAL_STACK_SIZE * 400 )//configMINIMAL_STACK_SIZE *5
...
#define ipconfigUSE_DHCP				0 // I set it to have static IP
#define ipconfigDHCP_REGISTER_HOSTNAME	0 // I set it to have static IP
...
#define ipconfigNUM_NETWORK_BUFFER_DESCRIPTORS		96//96
...
//#define ipconfigTCP_MSS 		1460 // added by me
...
#define ipconfigSUPPORT_OUTGOING_PINGS				0//ed
...
#define ipconfigTCP_WIN_SEG_COUNT 24//240

/* Each TCP socket has a circular buffers for Rx and Tx, which have a fixed
maximum size.  Define the size of Rx buffer for TCP soSSIZE_MAXSSIZE_MAXckets. */
#define ipconfigTCP_RX_BUFFER_LENGTH			( ipconfigTCP_MSS*8 ) //0x4000//ipconfigTCP_MSS*16

/* Define the size of Tx buffer for TCP sockets. */
#define ipconfigTCP_TX_BUFFER_LENGTH			( ipconfigTCP_MSS*8 ) //0x4000//ipconfigTCP_MSS*16
...
#define ipconfigTCP_HANG_PROTECTION_TIME		( 10 )//30
...
messages. */
#define ipconfigHAS_PRINTF			0//ed
